...
export default function CV9Page() {
    const [isVisible, setIsVisible] = useState(false);

    useEffect(() => {
        console.log('Conversion tracked - Wellness Goods');
        setIsVisible(true);
    }, []);
                ...
                <div className="cv-info-box">
                    ...
                    <div className="steps">
                        ...
                        <div className="step">
                            ...
                            <div className="step-content">
                                <h3>商品の発送</h3>
                                <p>1〜2営業日以内に発送いたします。アロマオイル3本も同梱します。</p>
                            </div>
                        </div>
                        <div className="step">
                            ...
                            <div className="step-content">
                                <h3>商品到着</h3>
                                <p>3〜5日でお届け予定です。癒しの時間をお楽しみください！</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="contact-methods">
                        <div className="contact-method">
                            ...
                            <div className="contact-info">
                                <h4>Email</h4>
                                <p>support@wellness-goods.example.com</p>
                            </div>
                        </div>
                    </div>
                </div>
